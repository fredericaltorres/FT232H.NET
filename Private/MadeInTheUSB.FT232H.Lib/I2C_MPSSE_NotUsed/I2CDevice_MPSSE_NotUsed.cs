...
namespace MadeInTheUSB.FT232H
{
    ...
    public class I2CDevice_MPSSE_NotUsed
    {
        ...
        GpioI2CImplementationDevice_MPSSE_NotUsed _gpios;
        public IDigitalWriteRead Gpios => _gpios;


        public I2CDevice_MPSSE_NotUsed(FTD2XX_NET.FTDI ftdiDevice, ClockEnum clockSpeed = ClockEnum.Clock600Khz_Divisor)
        {
            this._ftdiDevice = ftdiDevice;
            this.ClockSpeed = clockSpeed;
            if (!this.ConfigureMpsse())
                throw new ApplicationException($"Mpsse configuration failed");
            _gpios = new GpioI2CImplementationDevice_MPSSE_NotUsed(this);
        }
